...
internal object InkuRuntimeSettings {
    ...
    var smoothAnimations by mutableStateOf(true)
        private set
    var compactCards by mutableStateOf(true)
        private set
    ...
    val palette: InkuPalette
        get() = when (themeName) {
            ...
            "Pure dark" -> InkuPalette(
                background = Color.Black,
                navigation = Color(0xFF080A0B),
                navigationSoft = Color(0xFF131719),
                mint = Color(0xFF7FE0C2),
                text = Color(0xFFF5F8F8),
                mutedText = Color(0xFFB4C2C8),
                darkText = Color(0xFF050708)
            )
    ...
    fun initialize(context: Context) {
        ...
        compactCards = prefs.getBoolean("compact_cards", true)
